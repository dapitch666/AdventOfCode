...
def create_day_class(year, day, src_dir, day_class, name):
    ...
    with open(day_class, "w") as file:
        ...
        file.write("        day.setName(\"" + name + "\");\n")
        file.write("        List<String> input = day.readFile();\n")
        file.write("        day.setPart1(part1(input));\n")
        file.write("        day.setPart2(part2(input));\n")
        file.write("        day.printParts();\n")
        file.write("    }\n\n")
