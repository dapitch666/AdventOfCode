...
def create_day_class(year, day, src_dir, day_class, name):
    ...
    with open(day_class, "w") as file:
        ...
        file.write("        Day day = new Day" + str(day) + "();\n")
        file.write("        day.run();\n")
        file.write("    }\n\n")
        file.write("    public void execute() {\n")
        file.write("        this.setName(\"" + name + "\");\n")
        file.write("        List<String> input = this.readFile();\n")
        file.write("        this.setPart1(part1(input));\n")
        file.write("        this.setPart2(part2(input));\n")
        file.write("        this.printParts();\n")
        file.write("    }\n\n")
